...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [[
                    ...
                    InlineKeyboardButton('🌿 Movie Group 🌿', url='https://t.me/moviesanimerequest')
                ],[
    ...
    if len(message.command) != 2:
        buttons = [[
                  ...
                  InlineKeyboardButton('⚜️ Join Updates Channel ⚜️', url='https://t.me/moviesanimerequest')
                  ]]
        reply_markup = InlineKeyboardMarkup(buttons)
            ...
            try:
                ...
                await client.send_cached_media(
                    ...
                    reply_markup=InlineKeyboardMarkup(
                        [
                         [
                          InlineKeyboardButton("⚜️ Updates Channel ⚜️", url="t.me/Godslayerborutoo")
                         ],[ 
                            InlineKeyboardButton('🚀 Fast Download / Watch Online🖥️', callback_data=f'generate_stream_link:{file_id}') #Don't change anything without contacting me @LazyDeveloperr
                            ]
                        ]
